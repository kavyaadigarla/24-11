...
sem1=Label(result,text="Enter Semester1 Marks:")
sem1marks=Entry(result)
sem2=Label(result,text="Enter Semester2 Marks:")
sem2marks=Entry(result)
sem3=Label(result,text="Enter Semester3 Marks:")
sem3marks=Entry(result)
sem4=Label(result,text="Enter Semester4 Marks:")
sem4marks=Entry(result)
sem5=Label(result,text="Enter Semester5 Marks:")
sem5marks=Entry(result)
sem6=Label(result,text="Enter Semester6 Marks:")
